...
var playerCommands = {
    help: function (args) {
        if (this.playerTracker.userRole == UserRoleEnum.MODER) {
            ...
            this.writeLine("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
              ...
              if (this.playerTracker.userRole == UserRoleEnum.OWNER) {
            this.writeLine("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            this.writeLine("/skin %shark - change skin");
            this.writeLine("/kill - self kill");
            this.writeLine("/killall - kills everyone.")
            ...
            this.writeLine("/shutdown - SHUTDOWNS THE SERVER");
            this.writeLine("/status - Shows Status of the Server");
            this.writeLine("/kick - Kicks a player from the server W.I.P");
            this.writeLine("/ban - Bans a player from the server W.I.P");
            this.writeLine("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        } else {
            this.writeLine("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            this.writeLine("/skin %shark - change skin");
    ...
    skin: function (args) {
        ...
        this.writeLine("You commited die...");
            ...
            bc: function (args) {
           if (this.playerTracker.userRole != UserRoleEnum.ADMIN && this.playerTracker.userRole != UserRoleEnum.OWNER) {
...
this.gameServer.sendChatMessage(player, id, msg);
    ...
    status: function (args) {
        if (this.playerTracker.userRole != UserRoleEnum.ADMIN && this.playerTracker.userRole != UserRoleEnum.MODER && this.playerTracker.userRole != UserRoleEnum.OWNER) {
            this.writeLine("ERROR: access denied!");
            return;
        }
